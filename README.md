...
THOR (Transients at High Observed Redshifts) identifies distant Tidal Disruption Events (TDEs) and in [LSST data](https://rubinobservatory.org/).
...
Create and activate a virtual environment, then install the project for local development:
...
For more information on the pre-commit hooks used in this project, see the [documentation](https://lincc-ppt.readthedocs.io/en/latest/practices/precommit.html).
